...
from PyQt5.QtWidgets import QMainWindow, QApplication, QTableWidgetItem, QDateTimeEdit, QTableWidget, \
    ...
    QTextEdit, QSpinBox, QHeaderView, QVBoxLayout, QDialog
from PyQt5.QtCore import *
from PyQt5.QtCore import QRegExp, QDateTime, Qt
from PyQt5.QtGui import *
from PyQt5 import QtWidgets
from PyQt5.uic import loadUiType

FORM_CLASS, _ = loadUiType(path.join(path.dirname('__file__'), "dash_bon.ui"))
